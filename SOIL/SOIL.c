 ...
 * Revise 1:{
 * Time: 2016-4-12
 * Content: Add (line 35-38 && line 2008-2009)
 * Editor: Chu Donghao - China,NanJing (�����ƣ��й��Ͼ�)
 * Contact: 799017701@qq.com
 * }
 */
	...
	)
{
	...
	{
		/*	this will only work with RGB and ambient images */
	...
	)
{
	...
	{
		save_result = soil_stbi_write_bmp( filename,
				width, height, channels, (void*)data );
	} else
	if( image_type == SOIL_SAVE_TYPE_TGA )
	{
		save_result = soil_stbi_write_tga( filename,
				width, height, channels, (void*)data );
	} else
